...
// loglikmarg
vec loglikmarg(mat y, mat b, mat sigma, mat alph, mat dalph, mat tau);
RcppExport SEXP mcif_loglikmarg(SEXP ySEXP, SEXP bSEXP, SEXP sigmaSEXP, SEXP alphSEXP, SEXP dalphSEXP, SEXP tauSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< mat >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< mat >::type dalph(dalphSEXP);
    Rcpp::traits::input_parameter< mat >::type tau(tauSEXP);
    __result = Rcpp::wrap(loglikmarg(y, b, sigma, alph, dalph, tau));
    return __result;
END_RCPP
}
// pn
...
// loglik
vec loglik(mat y, mat b, mat sigma, mat alph, mat dalph, mat tau, mat eb0, int pred, int nq, double stepsize, unsigned iter, bool debug);
RcppExport SEXP mcif_loglik(SEXP ySEXP, SEXP bSEXP, SEXP sigmaSEXP, SEXP alphSEXP, SEXP dalphSEXP, SEXP tauSEXP, SEXP eb0SEXP, SEXP predSEXP, SEXP nqSEXP, SEXP stepsizeSEXP, SEXP iterSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< mat >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< unsigned >::type iter(iterSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    __result = Rcpp::wrap(loglik(y, b, sigma, alph, dalph, tau, eb0, pred, nq, stepsize, iter, debug));
    return __result;
END_RCPP
}
// EB
mat EB(mat y, mat b, mat sigma, mat alph, mat dalph, mat tau, int pred, double stepsize, unsigned iter, bool debug);
RcppExport SEXP mcif_EB(SEXP ySEXP, SEXP bSEXP, SEXP sigmaSEXP, SEXP alphSEXP, SEXP dalphSEXP, SEXP tauSEXP, SEXP predSEXP, SEXP stepsizeSEXP, SEXP iterSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< mat >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< unsigned >::type iter(iterSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    __result = Rcpp::wrap(EB(y, b, sigma, alph, dalph, tau, pred, stepsize, iter, debug));
    return __result;
END_RCPP
}
